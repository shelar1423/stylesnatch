      ...
      <div className="pt-24 sm:pt-32">
        ...
        <div className="mx-auto max-w-3xl px-6 sm:px-8 pb-32">
          ...
          >
            ...
            <h1 className="font-display text-4xl tracking-tight sm:text-5xl">Meet the Maker</h1>

            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              Hi, I'm <strong className="font-medium text-foreground">Digvijay Shelar</strong>. I'm
              a developer turned UX designer with a passion for building tools that sit squarely at
              the intersection of beautiful design and powerful AI.
            </p>

            <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
              I built <strong>Stylesnatch</strong> because I was tired of watching AI coding agents
              build generic, soulless UI components. I wanted a way to instantly "teach" an agent
              the exact design system of any website I loved, without manually typing out CSS
              variables and spacing rules for hours.
            </p>
